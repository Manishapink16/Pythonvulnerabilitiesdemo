...
def fetch_code_scanning_alerts(owner, repo, token):
    ...
    url = f'https://api.github.com/repos/Manishapink16/Pythonvulnerabilitiesdemo/code-scanning/alerts'
...
def main():
    ...
    token = os.getenv('MY_GITHUB_TOKEN')  # Retrieve GitHub token from environment variable
