...
def main():
    ...
    token = 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 #os.getenv('MINE_GITHUB_TOKEN')  # Retrieve GitHub token from environment variable
